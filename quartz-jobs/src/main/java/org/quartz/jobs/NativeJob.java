...
public class NativeJob implements Job {
  ...
  /**
   * Optional parameter (value should be 'true' or 'false') that specifies whether the job should wait for the execution
   * of the native process to complete before it completes.
   * <p>
  ...
  /**
   * Optional parameter (value should be 'true' or 'false') that specifies whether the spawned process's stdout and
   * stderr streams should be consumed. If the process creates output, it is possible that it might 'hang' if the
  ...
  class StreamConsumer extends Thread {
    ...
    /**
     * Runs this object as a separate thread, printing the contents of the InputStream supplied during instantiation, to
