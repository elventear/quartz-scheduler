...
/**
 * CommonJ WorkManager implementation of hacked Quartz ThreadExecutor class. This class schedules work on a WorkManager
 * which is looked up in JNDI. The advantage is that all the work performed is done on a managed thread which is
 * required by WebSphere, see <a href="http://jira.opensymphony.com/browse/QUARTZ-743">QUARTZ-743</a> for details.
 * 
 * @author matt.accola
