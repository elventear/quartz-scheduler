...
/**
 * <p>
 * An implementation of the <code>Scheduler</code> interface that remotely proxies all method calls to the equivalent
 * call on a given <code>QuartzScheduler</code> instance, via JBoss's JMX RMIAdaptor.
 * </p>
 * <p>
 * Set the <b>providerURL</b> property to your MBean server URL. This defaults to: <i>jnp://localhost:1099</i>
 * </p>
 * 
...
public class JBoss4RMIRemoteMBeanScheduler extends RemoteMBeanScheduler {
  ...
  /**
   * Set the remote MBean server URL. Defaults to: <i>jnp://localhost:1099</i>
   */
