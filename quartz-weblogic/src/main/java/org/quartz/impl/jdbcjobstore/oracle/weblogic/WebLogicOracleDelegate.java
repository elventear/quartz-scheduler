...
/**
 * Handle Blobs correctly when Oracle is being used inside of Weblogic 8.1, as discussed at:
 * http://edocs.bea.com/wls/docs81/jdbc/thirdparty.html#1043705
 * 
...
public class WebLogicOracleDelegate extends OracleDelegate {
   ...
   */
  public WebLogicOracleDelegate(Logger logger, String tablePrefix, String schedName, String instanceId,
  ...
  protected Blob writeDataToBlob(ResultSet rs, int column, byte[] data) throws SQLException {
    ...
    if (blob == null) { throw new SQLException("Driver's Blob representation is null!"); }
