...
public class QuartzScheduler implements RemotableQuartzScheduler {
    ...
    public QuartzScheduler(QuartzSchedulerResources resources,
            long idleWaitTime, long dbRetryInterval) throws SchedulerException {
    ...
    private boolean shouldRunUpdateCheck() {
        if (resources.isRunUpdateCheck()
                && !Boolean
                        .getBoolean(StdSchedulerFactory.PROP_SCHED_SKIP_UPDATE_CHECK)
    ...
    private Timer scheduleUpdateCheck() {
        ...
        rval.scheduleAtFixedRate(new UpdateChecker(), 1000, 7 * 24 * 60 * 60
                * 1000L);
        return rval;
    }
        ...
        Thread t = new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    getLog().error(
                            "Unable to start secheduler after startup delay.",
                            se);
                }
            }
        });
    ...
    public void shutdown(boolean waitForJobsToComplete) {
        ...
        // trigger and need time to release the trigger once halted, so make
        // sure
    ...
    public void scheduleJobs(Map<JobDetail, Set<Trigger>> triggersAndJobs,
    ...
    public void scheduleJob(JobDetail jobDetail, Set<Trigger> triggersForJob,
            boolean replace) throws SchedulerException {
    ...
    public void triggerJob(JobKey jobKey, JobDataMap data)
        ...
        // TODO: use builder
        OperableTrigger trig = new org.quartz.impl.triggers.SimpleTriggerImpl(
                newTriggerId(), Scheduler.DEFAULT_GROUP, jobKey.getName(),
                jobKey.getGroup(), new Date(), null, 0, 0);
