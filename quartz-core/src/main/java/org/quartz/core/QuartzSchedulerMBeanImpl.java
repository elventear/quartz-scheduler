...
public class QuartzSchedulerMBeanImpl extends StandardMBean implements NotificationEmitter, QuartzSchedulerMBean,
    JobListener, SchedulerListener {
  ...
  private static Method findMethod(Class<?> targetType, String methodName, Class<?>[] argTypes)
    ...
    if (beanInfo != null) {
      for (MethodDescriptor methodDesc : beanInfo.getMethodDescriptors()) {
        ...
        if (methodName.equals(method.getName()) && argTypes.length == parameterTypes.length) {
          ...
          if (matchedArgTypes) { return method; }
        }
      }
    }
    return null;
  ...
  public void scheduleJob(Map<String, Object> abstractJobInfo, Map<String, Object> abstractTriggerInfo)
      throws Exception {
    try {
      String triggerClassName = (String) abstractTriggerInfo.remove("triggerClass");
      if (triggerClassName == null) { throw new IllegalArgumentException("No triggerClass specified"); }
      ...
      if (jobDetailClassName == null) { throw new IllegalArgumentException("No jobDetailClass specified"); }
      ...
      if (jobClassName == null) { throw new IllegalArgumentException("No jobClass specified"); }
  ...
  public void scheduleJob(String jobName, String jobGroup, Map<String, Object> abstractTriggerInfo) throws Exception {
    try {
      ...
      if (jobDetail == null) { throw new IllegalArgumentException("No such job '" + jobKey + "'"); }
  ...
  public Date scheduleJob(String jobName, String jobGroup, String triggerName, String triggerGroup) throws Exception {
    try {
      ...
      if (trigger == null) { throw new IllegalArgumentException("No such trigger: " + triggerKey); }
  ...
  public void sendNotification(String eventType, Object data, String msg) {
    Notification notif = new Notification(eventType, this, sequenceNumber.incrementAndGet(),
