...
public interface QuartzSchedulerMBean {
     ...
     * @throws Exception
     */
    Date scheduleJob(String jobName, String jobGroup, String triggerName,
            String triggerGroup) throws Exception;

    /**
     * Schedules a job using the given Cron/Simple triggerInfo.
     * 
     * The triggerInfo and jobDetailInfo must contain well-known attribute
     * values. TriggerInfo attributes: name, group, description, calendarName,
     * priority, CronExpression | (startTime, endTime, repeatCount,
     * repeatInterval) JobDetailInfo attributes: name, group, description,
     * jobClass, jobDataMap, durability, shouldRecover
     */
     ...
     * specified by abstractTriggerInfo.
     * 
     * AbtractTriggerInfo and AbstractJobInfo must contain the following String
     * attributes. AbstractTriggerInfo: triggerClass, the fully-qualified class
     * name of a concrete Trigger type AbstractJobInfo: jobDetailClass, the
     * fully-qualified class name of a concrete JobDetail type
     * 
     * If the Trigger and JobDetail can be successfully instantiated, the
     * remaining attributes will be reflectively applied to those instances. The
     * remaining attributes are limited to the types: Integer, Double, Float,
     * String, Boolean, Date, Character, Map<String, Object>. Maps are further
     ...
     * name under the key "triggerClass." That trigger type must contain a
     * no-arg constructor and have public access. Other attributes are applied
     * reflectively and are limited to the types: Integer, Double, Float,
     * String, Boolean, Date, Character, Map<String, Object>. Maps are limited
     * to containing values from the same set of types, less Map itself.
     * 
     * @param jobName
     * @param jobGroup
     ...
     * Object>. Maps are limited to containing values from the same set of
    ...
    /**
     * @return List of CompositeData:[CronTrigger|SimpleTrigger] for the
     *         specified job.
     * @see TriggerSupport
     */
