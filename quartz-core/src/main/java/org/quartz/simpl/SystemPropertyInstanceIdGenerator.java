 ...
 * property.
 * 
 * You can also set the properties "postpend" and "prepend" to String values
 * that will be added to the beginning or end (respectively) of the value found
 * in the system property.
 * 
 * If no value set for the property, a {@link org.quartz.SchedulerException} is
 * thrown
 * 
 * @author Alex Snaps
 */
public class SystemPropertyInstanceIdGenerator implements InstanceIdGenerator {
    ...
    /**
     * Returns the cluster wide value for this scheduler instance's id, based on
     * a system property
     * 
    ...
    public void setSystemPropertyName(String systemPropertyName) {
        this.systemPropertyName = systemPropertyName == null ? SYSTEM_PROPERTY
                : systemPropertyName.trim();
    }
