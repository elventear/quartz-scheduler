...
public class TimeOfDay implements Serializable {
     ...
     *             if one or more of the input values is out of their valid
     *             range.
     */
     ...
     *             range.
     */
    public static TimeOfDay hourMinuteAndSecondOfDay(int hour, int minute,
            int second) {
    ...
    /**
     * Return a date with time of day reset to this object values. The
     * millisecond value will be zero.
     */
     ...
     * 
     * @param dateTime
     *            The java.util.Date from which to extract Hour, Minute and
     *            Second.
     */
     ...
     *            Second.
     * @param tz
     *            The TimeZone from which relate Hour, Minute and Second for the
     *            given date. If null, system default TimeZone will be used.
     */
    public static TimeOfDay hourAndMinuteAndSecondFromDate(Date dateTime,
            TimeZone tz) {
        if (dateTime == null)
        ...
        return new TimeOfDay(cal.get(Calendar.HOUR_OF_DAY),
                cal.get(Calendar.MINUTE), cal.get(Calendar.SECOND));
    }

    /**
     * Create a TimeOfDay from the given date (at the zero-second), in the
     ...
     *            The java.util.Date from which to extract Hour and Minute.
     * @param tz
     *            The TimeZone from which relate Hour and Minute for the given
