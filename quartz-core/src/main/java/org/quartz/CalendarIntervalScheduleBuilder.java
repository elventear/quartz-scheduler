 ...
 *         .withSchedule(withIntervalInDays(3)).startAt(futureDate(10, MINUTES))
 *         .build();
 * 
 ...
 * @see TriggerBuilder
 */
public class CalendarIntervalScheduleBuilder extends
     ...
     * @see CalendarIntervalTrigger#getRepeatIntervalUnit()
     */
    public CalendarIntervalScheduleBuilder withIntervalInSeconds(
     ...
     * @see CalendarIntervalTrigger#getRepeatIntervalUnit()
     */
    public CalendarIntervalScheduleBuilder withIntervalInMinutes(
     ...
     * @see CalendarIntervalTrigger#getRepeatIntervalUnit()
     */
    public CalendarIntervalScheduleBuilder withIntervalInHours(
            int intervalInHours) {
    ...
    /**
     * Specify an interval in the IntervalUnit.DAY that the produced Trigger
     * will repeat at.
     * 
    ...
    /**
     * Specify an interval in the IntervalUnit.WEEK that the produced Trigger
     * will repeat at.
     * 
     ...
     * @see CalendarIntervalTrigger#getRepeatIntervalUnit()
     */
    public CalendarIntervalScheduleBuilder withIntervalInWeeks(
            int intervalInWeeks) {
     ...
     * @see CalendarIntervalTrigger#getRepeatIntervalUnit()
     */
    public CalendarIntervalScheduleBuilder withIntervalInMonths(
    ...
    /**
     * Specify an interval in the IntervalUnit.YEAR that the produced Trigger
     * will repeat at.
     * 
    ...
    /**
     * If the Trigger misfires, use the
     * {@link CalendarIntervalTrigger#MISFIRE_INSTRUCTION_DO_NOTHING}
     * instruction.
     * 
     * @return the updated CalendarIntervalScheduleBuilder
     ...
     */
    public CalendarIntervalScheduleBuilder skipDayIfHourDoesNotExist(
            boolean skipDay) {
