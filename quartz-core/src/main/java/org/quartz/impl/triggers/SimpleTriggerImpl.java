...
/**
 * <p>
 * A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link org.quartz.JobDetail}</code> at a given
 * moment in time, and optionally repeated at a specified interval.
 * </p>
 * 
 * @see Trigger
 * @see CronTrigger
...
public class SimpleTriggerImpl extends AbstractTrigger<SimpleTrigger> implements SimpleTrigger, CoreTrigger {
  ...
  /**
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur immediately, and repeat at the the given interval the given
   * number of times.
   * </p>
   * 
   * @deprecated use a TriggerBuilder instead
  ...
  /**
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur at the given time, and repeat at the the given interval the
  ...
  /**
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur at the given time, fire the identified <code>Job</code> and
   * repeat at the the given interval the given number of times, or until the given end time.
   * </p>
   * 
   * @param startTime A <code>Date</code> set to the time for the <code>Trigger</code> to fire.
   * @param endTime A <code>Date</code> set to the time for the <code>Trigger</code> to quit repeat firing.
   * @param repeatCount The number of times for the <code>Trigger</code> to repeat firing, use
   *        {@link #REPEAT_INDEFINITELY}for unlimitted times.
   * @param repeatInterval The number of milliseconds to pause between the repeat firing.
   * @deprecated use a TriggerBuilder instead
   */
  @Deprecated
  public SimpleTriggerImpl(String name, String group, String jobName, String jobGroup, Date startTime, Date endTime,
  ...
  /**
   * <p>
   * Get the time at which the <code>SimpleTrigger</code> should quit repeating - even if repeastCount isn't yet
   * satisfied.
   * </p>
   * 
  ...
  /**
   * <p>
   * Set the the number of time the <code>SimpleTrigger</code> should repeat, after which it will be automatically
   * deleted.
   * </p>
   * 
  ...
  public void setRepeatInterval(long repeatInterval) {
    if (repeatInterval < 0) { throw new IllegalArgumentException("Repeat interval must be >= 0"); }
  ...
  protected boolean validateMisfireInstruction(int misfireInstruction) {
    ...
    if (misfireInstruction > MISFIRE_INSTRUCTION_RESCHEDULE_NEXT_WITH_EXISTING_COUNT) { return false; }
  ...
  /**
   * <p>
   * Updates the <code>SimpleTrigger</code>'s state based on the MISFIRE_INSTRUCTION_XXX that was selected when the
   ...
   * MISFIRE_INSTRUCTION_RESCHEDULE_NEXT_WITH_REMAINING_COUNT with a trigger that has a non-null end-time may cause the
   * trigger to never fire again if the end-time arrived during the misfire time span.</li>
   * <li>If the Repeat Count is <code>&gt; 0</code>, then the instruction will be interpreted as
  ...
  /**
   * <p>
   * Returns the previous time at which the <code>SimpleTrigger</code> fired. If the trigger has not yet fired,
  ...
  /**
   * <p>
   * Returns the next time at which the <code>SimpleTrigger</code> will fire, after the given time. If the trigger will
  ...
  public Date getFireTimeAfter(Date afterTime) {
    ...
    if ((timesTriggered > repeatCount) && (repeatCount != REPEAT_INDEFINITELY)) { return null; }

    if (afterTime == null) {
      afterTime = new Date();
    }

    if (repeatCount == 0 && afterTime.compareTo(getStartTime()) >= 0) { return null; }
    ...
    if ((numberOfTimesExecuted > repeatCount) && (repeatCount != REPEAT_INDEFINITELY)) { return null; }
  ...
  /**
   * <p>
   * Returns the last time at which the <code>SimpleTrigger</code> will fire, before the given time. If the trigger will
   * not fire before the given time, <code>null</code> will be returned.
   * </p>
   */
  ...
  /**
   * <p>
   * Returns the final time at which the <code>SimpleTrigger</code> will fire, if repeatCount is REPEAT_INDEFINITELY,
  ...
  public Date getFinalFireTime() {
    ...
    if (repeatCount == REPEAT_INDEFINITELY) { return (getEndTime() == null) ? null : getFireTimeBefore(getEndTime()); }
  ...
  public void validate() throws SchedulerException {
    ...
    if (repeatCount != 0 && repeatInterval < 1) { throw new SchedulerException("Repeat Interval cannot be zero."); }
  }

  /**
   * Used by extensions of SimpleTrigger to imply that there are additional properties, specifically so that extensions
   * can choose whether to be stored as a serialized blob, or as a flattened SimpleTrigger table.
   */
