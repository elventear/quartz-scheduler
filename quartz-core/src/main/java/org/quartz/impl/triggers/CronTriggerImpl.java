...
/**
 * <p>
 * A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link org.quartz.JobDetail}</code> at given
 * moments in time, defined with Unix 'cron-like' definitions.
 * </p>
 * 
...
public class CronTriggerImpl extends AbstractTrigger<CronTrigger> implements CronTrigger, CoreTrigger {
  ...
  /**
   * Required for serialization support. Introduced in Quartz 1.6.1 to maintain compatibility after the introduction of
   * hasAdditionalProperties method.
   * 
   ...
   * </p>
   * <p>
   * The start-time will also be set to the current time, and the time zone will be set the the system's default time
   * zone.
   * </p>
   */
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> with the given name, group and expression.
   * </p>
   * <p>
   * The start-time will also be set to the current time, and the time zone will be set the the system's default time
   * zone.
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> with the given name and group, and associated with the identified
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> with the given name and group, associated with the identified
   * <code>{@link org.quartz.JobDetail}</code>, and with the given "cron" expression.
   * </p>
   * <p>
   * The start-time will also be set to the current time, and the time zone will be set the the system's default time
   * zone.
   ...
   * <p>
   * Create a <code>CronTrigger</code> with the given name and group, associated with the identified
   * <code>{@link org.quartz.JobDetail}</code>, and with the given "cron" expression resolved with respect to the
   * <code>TimeZone</code>.
   * </p>
   * 
   * @deprecated use a TriggerBuilder instead
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> that will occur at the given time, until the given end time.
   * </p>
   * <p>
   ...
   */
  @Deprecated
  public CronTriggerImpl(String name, String group, String jobName, String jobGroup, Date startTime, Date endTime,
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> with fire time dictated by the <code>cronExpression</code> resolved with respect
   * to the specified <code>timeZone</code> occurring from the <code>startTime</code> until the given
   * <code>endTime</code>.
   * </p>
   * <p>
   * If null, the start-time will also be set to the current time. If null, the time zone will be set to the system's
   * default.
   * </p>
   * 
   * @param name of the <code>Trigger</code>
   * @param group of the <code>Trigger</code>
   * @param jobName name of the <code>{@link org.quartz.JobDetail}</code> executed on firetime
   * @param jobGroup group of the <code>{@link org.quartz.JobDetail}</code> executed on firetime
   * @param startTime A <code>Date</code> set to the earliest time for the <code>Trigger</code> to start firing.
   * @param endTime A <code>Date</code> set to the time for the <code>Trigger</code> to quit repeat firing.
   * @param cronExpression A cron expression dictating the firing sequence of the <code>Trigger</code>
   * @param timeZone Specifies for which time zone the <code>cronExpression</code> should be interpreted, i.e. the
   *        expression 0 0 10 * * ?, is resolved to 10:00 am in this time zone.
  ...
  /**
   * Set the CronExpression to the given one. The TimeZone on the passed-in CronExpression over-rides any that was
  ...
  /**
   * <p>
   * Get the time at which the <code>CronTrigger</code> should quit repeating - even if repeastCount isn't yet
   * satisfied.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the previous time at which the <code>CronTrigger</code> fired. If the trigger has not yet fired,
  ...
  /**
   * <p>
   * Sets the next time at which the <code>CronTrigger</code> will fire. <b>This method should not be invoked by client
   * code.</b>
   * </p>
   */
   ...
   * </p>
   * <p>
   * If {@link #setCronExpression(CronExpression)} is called after this method, the TimeZon setting on the
   * CronExpression will "win". However if {@link #setCronExpression(String)} is called after this method, the time zone
   * applied by this method will remain in effect, since the String cron expression does not carry a time zone!
   */
  ...
  /**
   * <p>
   * Returns the next time at which the <code>CronTrigger</code> will fire, after the given time. If the trigger will
   * not fire after the given time, <code>null</code> will be returned.
   * </p>
   * <p>
  ...
  public Date getFireTimeAfter(Date afterTime) {
    ...
    if (getEndTime() != null && (afterTime.compareTo(getEndTime()) >= 0)) { return null; }

    Date pot = getTimeAfter(afterTime);
    if (getEndTime() != null && pot != null && pot.after(getEndTime())) { return null; }
  ...
  public Date getFinalFireTime() {
    ...
    if ((resultTime != null) && (getStartTime() != null) && (resultTime.before(getStartTime()))) { return null; }
  ...
  /**
   * <p>
   * Updates the <code>CronTrigger</code>'s state based on the MISFIRE_INSTRUCTION_XXX that was selected when the
  ...
  /**
   * <p>
   * Determines whether the date and (optionally) time of the given Calendar instance falls on a scheduled fire-time of
   * this trigger.
   * </p>
   * <p>
   ...
   * 
   * @param test the date to compare
   * @param dayOnly if set to true, the method will only determine if the trigger will fire during the day represented
   *        by the given Calendar (hours, minutes and seconds will be ignored).
  ...
  public boolean willFireOn(Calendar test, boolean dayOnly) {
    ...
    if (dayOnly) { return (year == test.get(Calendar.YEAR) && month == test.get(Calendar.MONTH) && day == test
        .get(Calendar.DATE)); }
    ...
    if (fta.equals(testTime)) { return true; }
  ...
  /**
   * Used by extensions of CronTrigger to imply that there are additional properties, specifically so that extensions
   * can choose whether to be stored as a serialized blob, or as a flattened CronTrigger table.
   */
