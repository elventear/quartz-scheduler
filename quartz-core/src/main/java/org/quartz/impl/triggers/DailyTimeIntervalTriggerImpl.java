 ...
 * <code>{@link org.quartz.JobDetail}</code> based upon daily repeating time intervals.
 * <p>
 * The trigger will fire every N (see {@link #setRepeatInterval(int)} ) seconds, minutes or hours (see
 * {@link #setRepeatIntervalUnit(IntervalUnit)}) during a given time window on specified days of the week.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * On each day, the starting fire time is reset to startTimeOfDay value, and then it will add repeatInterval value to it
 * until the endTimeOfDay is reached. If you set daysOfWeek values, then fire time will only occur during those week
 * days period. Again, remember this trigger will reset fire time each day with startTimeOfDay, regardless of your
 * interval or endTimeOfDay!
 * </p>
 * <p>
 * The default values for fields if not set are: startTimeOfDay defaults to 00:00:00, the endTimeOfDay default to
 * 23:59:59, and daysOfWeek is default to every day. The startTime default to current time-stamp now, while endTime has
 * not value.
 * </p>
 * <p>
 * If startTime is before startTimeOfDay, then startTimeOfDay will be used and startTime has no affect. Else if
 * startTime is after startTimeOfDay, then the first fire time for that day will be the next interval after the
 * startTime. For example, if you set startingTimeOfDay=9am, endingTimeOfDay=11am, interval=15 mins, and
 * startTime=9:33am, then the next fire time will be 9:45pm. Note also that if you do not set startTime value, the
 * trigger builder will default to current time, and current time maybe before or after the startTimeOfDay! So be aware
 * how you set your startTime.
 * </p>
 * <p>
 * This trigger also supports "repeatCount" feature to end the trigger fire time after a certain number of count is
 * reached. Just as the SimpleTrigger, setting repeatCount=0 means trigger will fire once only! Setting any positive
 * count then the trigger will repeat count + 1 times. Unlike SimpleTrigger, the default value of repeatCount of this
 * trigger is set to REPEAT_INDEFINITELY instead of 0 though.
 * 
 ...
 */
public class DailyTimeIntervalTriggerImpl extends AbstractTrigger<DailyTimeIntervalTrigger> implements
  ...
  /**
   * <p>
   * Create a <code>DailyTimeIntervalTrigger</code> that will occur immediately, and repeat at the the given interval.
   * </p>
   * 
   ...
   */
  public DailyTimeIntervalTriggerImpl(String name, TimeOfDay startTimeOfDay, TimeOfDay endTimeOfDay,
   ...
   * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
   */
  public DailyTimeIntervalTriggerImpl(String name, String group, TimeOfDay startTimeOfDay, TimeOfDay endTimeOfDay,
                                      IntervalUnit intervalUnit, int repeatInterval) {
  ...
  /**
   * <p>
   * Create a <code>DailyTimeIntervalTrigger</code> that will occur at the given time, and repeat at the the given
   ...
   * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
   */
  public DailyTimeIntervalTriggerImpl(String name, Date startTime, Date endTime, TimeOfDay startTimeOfDay,
   ...
   * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
   */
  public DailyTimeIntervalTriggerImpl(String name, String group, Date startTime, Date endTime,
                                      TimeOfDay startTimeOfDay, TimeOfDay endTimeOfDay, IntervalUnit intervalUnit,
                                      int repeatInterval) {
    super(name, group);
  ...
  /**
   * <p>
   * Create a <code>DailyTimeIntervalTrigger</code> that will occur at the given time, fire the identified
   * <code>Job</code> and repeat at the the given interval until the given end time.
   * </p>
   * 
   * @param startTime A <code>Date</code> set to the time for the <code>Trigger</code> to fire.
   * @param endTime A <code>Date</code> set to the time for the <code>Trigger</code> to quit repeat firing.
   ...
   * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
   */
  public DailyTimeIntervalTriggerImpl(String name, String group, String jobName, String jobGroup, Date startTime,
  ...
  /**
   * <p>
   * Get the time at which the <code>DailyTimeIntervalTrigger</code> should occur. It defaults to the getStartTimeOfDay
   * of current day.
   * </p>
   */
  @Override
  ...
  public void setStartTime(Date startTime) {
    ...
    if (eTime != null && eTime.before(startTime)) { throw new IllegalArgumentException(
  ...
  /**
   * <p>
   * Set the time at which the <code>DailyTimeIntervalTrigger</code> should quit repeating (and be automatically
   * deleted).
   * </p>
   * 
  ...
  public void setEndTime(Date endTime) {
    ...
    if (sTime != null && endTime != null && sTime.after(endTime)) { throw new IllegalArgumentException(
                                                                                                       "End time cannot be before start time"); }
  ...
  public void setRepeatIntervalUnit(IntervalUnit intervalUnit) {
    if (repeatIntervalUnit == null
        || !((repeatIntervalUnit.equals(IntervalUnit.SECOND) || repeatIntervalUnit.equals(IntervalUnit.MINUTE) || repeatIntervalUnit
            .equals(IntervalUnit.HOUR)))) throw new IllegalArgumentException(
  ...
  /**
   * <p>
   * set the the time interval that will be added to the <code>DailyTimeIntervalTrigger</code>'s fire time (in the set
   * repeat interval unit) in order to calculate the time of the next trigger repeat.
   * </p>
   * 
   * @exception IllegalArgumentException if repeatInterval is < 1
   */
  public void setRepeatInterval(int repeatInterval) {
    if (repeatInterval < 0) { throw new IllegalArgumentException("Repeat interval must be >= 1"); }
  ...
  protected boolean validateMisfireInstruction(int misfireInstruction) {
    if (misfireInstruction < MISFIRE_INSTRUCTION_IGNORE_MISFIRE_POLICY) { return false; }
  ...
  /**
   * <p>
   * Updates the <code>DailyTimeIntervalTrigger</code>'s state based on the MISFIRE_INSTRUCTION_XXX that was selected
   * when the <code>DailyTimeIntervalTrigger</code> was created.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Called when the <code>{@link Scheduler}</code> has decided to 'fire' the trigger (execute the associated
   * <code>Job</code>), in order to give the <code>Trigger</code> a chance to update itself for its next triggering (if
   * any).
   * </p>
   * 
  ...
  public void updateWithNewCalendar(org.quartz.Calendar calendar, long misfireThreshold) {
    ...
    if (nextFireTime == null || calendar == null) { return; }
  ...
  /**
   * <p>
   * Called by the scheduler at the time a <code>Trigger</code> is first added to the scheduler, in order to have the
   * <code>Trigger</code> compute its first fire time, based on any associated calendar.
   * </p>
   * <p>
   * After this method has been called, <code>getNextFireTime()</code> should return a valid answer.
   * </p>
   * 
   * @return the first time at which the <code>Trigger</code> will be fired by the scheduler, which is also the same
   *         value <code>getNextFireTime()</code> will return (until after the first firing of the <code>Trigger</code>
   *         ). </p>
   */
  @Override
  public Date computeFirstFireTime(org.quartz.Calendar calendar) {
    ...
    while (nextFireTime != null && calendar != null && !calendar.isTimeIncluded(nextFireTime.getTime())) {
      ...
      java.util.Calendar c = java.util.Calendar.getInstance();
      c.setTime(nextFireTime);
      if (c.get(java.util.Calendar.YEAR) > YEAR_TO_GIVEUP_SCHEDULING_AT) { return null; }
    }
  ...
  /**
   * <p>
   * Returns the next time at which the <code>Trigger</code> is scheduled to fire. If the trigger will not fire again,
   * <code>null</code> will be returned. Note that the time returned can possibly be in the past, if the time that was
   ...
   * </p>
   * <p>
   * The value returned is not guaranteed to be valid until after the <code>Trigger</code> has been added to the
   * scheduler.
   * </p>
   */
  @Override
  ...
  /**
   * <p>
   * Returns the previous time at which the <code>DailyTimeIntervalTrigger</code> fired. If the trigger has not yet
  ...
  /**
   * <p>
   * Returns the next time at which the <code>DailyTimeIntervalTrigger</code> will fire, after the given time. If the
  ...
  public Date getFireTimeAfter(Date afterTime) {
    ...
    if (repeatCount != REPEAT_INDEFINITELY && timesTriggered > repeatCount) { return null; }
    ...
    if (fireTime.getTime() < startTime.getTime() && startTime.getTime() < fireTimeStartDate.getTime()) {
      ...
      return startTime;
    } else if (fireTime.getTime() > startTime.getTime() && fireTime.getTime() < fireTimeStartDate.getTime()) { return fireTimeStartDate; }
   ...
   * @param forceToAdvanceNextDay - flag to whether to advance day without check existing week day. This scenario can
   *        happen when a caller determine fireTime has passed the endTimeOfDay that fireTime should move to next day
   *        anyway.
  ...
  private Date advanceToNextDayOfWeek(Date fireTime, boolean forceToAdvanceNextDay) {
    ...
    Date eTime = getEndTime();
    if (eTime != null && fireTime.getTime() > eTime.getTime()) { return null; }
  ...
  /**
   * <p>
   * Returns the final time at which the <code>DailyTimeIntervalTrigger</code> will fire, if there is no end time set,
  ...
  public Date getFinalFireTime() {
    if (complete || getEndTime() == null) { return null; }
  ...
  public void validate() throws SchedulerException {
    ...
    if (repeatIntervalUnit == null
        || !(repeatIntervalUnit.equals(IntervalUnit.SECOND) || repeatIntervalUnit.equals(IntervalUnit.MINUTE) || repeatIntervalUnit
            .equals(IntervalUnit.HOUR))) throw new SchedulerException(
                                                                      "Invalid repeat IntervalUnit (must be SECOND, MINUTE or HOUR).");
    if (repeatInterval < 1) { throw new SchedulerException("Repeat Interval cannot be zero."); }

    // Ensure interval does not exceed 24 hours
    long secondsInHour = 24 * 60 * 60L;
    if (repeatIntervalUnit == IntervalUnit.SECOND && repeatInterval > secondsInHour) { throw new SchedulerException(
                                                                                                                    "repeatInterval can not exceed 24 hours ("
                                                                                                                        + secondsInHour
                                                                                                                        + " seconds). Given "
                                                                                                                        + repeatInterval); }
    if (repeatIntervalUnit == IntervalUnit.MINUTE && repeatInterval > secondsInHour / 60L) { throw new SchedulerException(
                                                                                                                          "repeatInterval can not exceed 24 hours ("
                                                                                                                              + secondsInHour
                                                                                                                              / 60L
                                                                                                                              + " minutes). Given "
                                                                                                                              + repeatInterval); }
    if (repeatIntervalUnit == IntervalUnit.HOUR && repeatInterval > 24) { throw new SchedulerException(
                                                                                                       "repeatInterval can not exceed 24 hours. Given "
                                                                                                           + repeatInterval
                                                                                                           + " hours."); }

    // Ensure timeOfDay is in order.
    if (getEndTimeOfDay() != null && !getStartTimeOfDay().before(getEndTimeOfDay())) { throw new SchedulerException(
                                                                                                                    "StartTimeOfDay "
                                                                                                                        + startTimeOfDay
  ...
  public void setDaysOfWeek(Set<Integer> daysOfWeek) {
    if (daysOfWeek == null || daysOfWeek.size() == 0) throw new IllegalArgumentException(
                                                                                         "DaysOfWeek set must be a set that contains at least one day.");
    else if (daysOfWeek.size() == 0) throw new IllegalArgumentException("DaysOfWeek set must contain at least one day.");
  ...
  public void setStartTimeOfDay(TimeOfDay startTimeOfDay) {
    if (startTimeOfDay == null) throw new IllegalArgumentException("Start time of day cannot be null");

    TimeOfDay eTime = getEndTimeOfDay();
    if (eTime != null && eTime.before(startTimeOfDay)) { throw new IllegalArgumentException(
  ...
  public void setEndTimeOfDay(TimeOfDay endTimeOfDay) {
    ...
    if (sTime != null && endTimeOfDay.before(endTimeOfDay)) { throw new IllegalArgumentException(
                                                                                                 "End time of day cannot be before start time of day"); }
  ...
  public ScheduleBuilder<DailyTimeIntervalTrigger> getScheduleBuilder() {
    ...
    DailyTimeIntervalScheduleBuilder cb = DailyTimeIntervalScheduleBuilder.dailyTimeIntervalSchedule()
        .withInterval(getRepeatInterval(), getRepeatIntervalUnit()).onDaysOfTheWeek(getDaysOfWeek())
        .startingDailyAt(getStartTimeOfDay()).endingDailyAt(getEndTimeOfDay());
  ...
  public void setRepeatCount(int repeatCount) {
    if (repeatCount < 0 && repeatCount != REPEAT_INDEFINITELY) { throw new IllegalArgumentException(
