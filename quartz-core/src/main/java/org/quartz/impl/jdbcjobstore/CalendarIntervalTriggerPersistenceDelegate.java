...
public class CalendarIntervalTriggerPersistenceDelegate extends
        SimplePropertiesTriggerPersistenceDelegateSupport {

    public boolean canHandleTriggerType(OperableTrigger trigger) {
        return ((trigger instanceof CalendarIntervalTriggerImpl) && !((CalendarIntervalTriggerImpl) trigger)
    ...
    protected TriggerPropertyBundle getTriggerPropertyBundle(
        ...
        TimeZone tz = null; // if we use null, that's ok as system default tz
                            // will be used
        ...
        return new TriggerPropertyBundle(sb, statePropertyNames,
                statePropertyValues);
    }
