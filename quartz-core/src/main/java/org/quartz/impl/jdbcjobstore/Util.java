...
public final class Util {
  ...
  public static void setBeanProps(Object obj, String[] propNames, Object[] propValues) throws JobPersistenceException {
    ...
    if (propNames.length != propValues.length) throw new IllegalArgumentException(
                                                                                  "propNames[].lenght != propValues[].length");
    ...
    try {
      ...
      throw new JobPersistenceException("Unable to set property named: " + name + " of object of type: "
