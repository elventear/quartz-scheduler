...
public interface JobStore {
     ...
     */
    void storeCalendar(String name, Calendar calendar, boolean replaceExisting,
     ...
     */
    List<OperableTrigger> acquireNextTriggers(long noLaterThan, int maxCount,
     ...
     * stateful.
     */
    void triggeredJobComplete(OperableTrigger trigger, JobDetail jobDetail,
