...
public class CalendarIntervalTriggerTest extends SerializationTestSupport {
  ...
  public void testDaylightSavingsTransitions() {
    ...
    assertEquals("Day increment result not as expected over spring 2010 daylight savings transition.",
                 targetCalendar.getTime(), testTime);
    ...
    // And again, Pick a day before a spring daylight savings transition... (QTZ-240) - and prove time of day is not
    // preserved without setPreserveHourOfDayAcrossDaylightSavings(true)
    ...
    // And again, Pick a day before a spring daylight savings transition... (QTZ-240) - and prove time of day is
    // preserved with setPreserveHourOfDayAcrossDaylightSavings(true)
