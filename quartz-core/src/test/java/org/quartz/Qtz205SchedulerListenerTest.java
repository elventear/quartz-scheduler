...
/**
 * A unit test to reproduce QTZ-205 bug: A TriggerListener vetoed job will affect SchedulerListener's triggerFinalized()
 * notification.
 * 
...
public class Qtz205SchedulerListenerTest {
  ...
  public void testTriggerFinalized() throws Exception {
    ...
    Trigger trigger = newTrigger().withIdentity("test")
        .withSchedule(simpleSchedule().withIntervalInMilliseconds(250).withRepeatCount(2)).build();
